...
int main()
{
    ...
    {                                               //main while loop
        ...
        lm73_temp_C = lm73_temp / (float)128;       // how to find the temp in C
        lm73_temp_F = ((float)lm73_temp_C * 9 / 5) + 32;    // convert C to F
        itoa(lm73_temp_F, lcd_string_array, 10);      //convert to string in array with itoa() from avr-libc
        ...
        uart_putc('F'); // display F for the temp
