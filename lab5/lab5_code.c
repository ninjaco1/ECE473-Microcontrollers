...
static uint8_t encoderUp = 0;        //  toggle radio up
...
void snoozekiller(void)
{
    ...
    setAlarm = 0;
    // clear_display(); // when this is common it out the temp changes numbers
...
ISR(USART0_RX_vect)
{
    ...
    lcd_string_array_master[i++] = rx_char; //store in array
